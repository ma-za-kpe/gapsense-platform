...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "strand_number", sa.SmallInteger(), nullable=False, comment="Strand number (1-5)"
        ),
        sa.Column(
            "name",
        ...
        sa.Column(
            "color_hex", sa.String(length=7), nullable=True, comment="UI color code (#RRGGBB)"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=False,
            comment="Who started: parent, teacher, system, self",
        ),
        sa.Column(
            "channel",
            sa.String(length=20),
            nullable=False,
            comment="Where: whatsapp, web, app, sms, paper",
        ),
        sa.Column(
            "status",
            sa.String(length=20),
        ...
        sa.Column(
            ...
            sa.String(length=5),
            nullable=False,
            comment="Grade level started at (B1-B9)",
        ),
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Array of tested node IDs",
        ),
        ...
        sa.Column(
            "root_gap_node_id", sa.UUID(), nullable=True, comment="Deepest root gap identified"
        ),
        sa.Column("root_gap_confidence", sa.Float(), nullable=True, comment="Confidence 0.0-1.0"),
        sa.Column(
            "cascade_path_id", sa.Integer(), nullable=True, comment="Which cascade pattern matched"
        ),
        sa.Column("prompt_version_id", sa.UUID(), nullable=True),
        sa.Column(
            "model_used", sa.String(length=50), nullable=True, comment="e.g., 'claude-sonnet-4-5'"
        ),
        ...
        sa.Column(
            ...
            nullable=True,
            comment="Full chain-of-thought (encrypted at rest)",
        ),
    ...
    op.create_index(
        "idx_sessions_root_gap", "diagnostic_sessions", ["root_gap_node_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.ARRAY(sa.UUID()),
            nullable=False,
            comment="Nodes confirmed mastered",
        ),
        sa.Column(
            "gap_nodes",
            postgresql.ARRAY(sa.UUID()),
            nullable=False,
            comment="Nodes with confirmed gaps",
        ),
        sa.Column(
            "uncertain_nodes", postgresql.ARRAY(sa.UUID()), nullable=False, comment="Need more data"
        ),
        sa.Column("primary_gap_node", sa.UUID(), nullable=True, comment="The deepest root gap"),
        sa.Column(
            "primary_cascade", sa.String(length=100), nullable=True, comment="Which cascade path"
        ),
        sa.Column(
            "secondary_gaps",
            postgresql.ARRAY(sa.UUID()),
            nullable=False,
            comment="Additional gap roots",
        ),
        sa.Column(
            "recommended_focus_node", sa.UUID(), nullable=True, comment="What to work on FIRST"
        ),
        sa.Column(
            "recommended_activity", sa.Text(), nullable=True, comment="Specific activity for parent"
        ),
        sa.Column(
            "estimated_grade_level",
            sa.String(length=5),
            nullable=True,
            comment="Functional grade level",
        ),
        sa.Column(
            "grade_gap", sa.SmallInteger(), nullable=True, comment="Difference from enrolled grade"
        ),
        sa.Column(
            "overall_confidence",
            sa.Float(),
            nullable=True,
            comment="How confident we are in this profile (0.0-1.0)",
        ),
        sa.Column(
            "is_current",
            sa.Boolean(),
            nullable=False,
            comment="Only one current profile per student",
        ),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("NOW()"), nullable=False),
        sa.Column("id", sa.Uuid(), nullable=False, comment="UUID primary key"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "current_grade", sa.String(length=5), nullable=False, comment="Enrolled grade (B1-B9)"
        ),
        sa.Column(
            "grade_as_of",
            sa.Date(),
        ...
        sa.Column(
            "home_language", sa.String(length=30), nullable=True, comment="L1 spoken at home"
        ),
        sa.Column(
            "school_language",
            sa.String(length=30),
            nullable=False,
            comment="Language of instruction at school",
        ),
        sa.Column(
            "latest_gap_profile_id", sa.Uuid(), nullable=True, comment="FK to current gap profile"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=True,
            comment="Ghana Education Service district code",
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "version", sa.String(length=20), nullable=False, comment="Semantic versioning: '1.0.0'"
        ),
        sa.Column(
            "name",
            sa.String(length=200),
            nullable=False,
            comment="e.g., 'Diagnostic Reasoning Prompt v2'",
        ),
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
            comment="Expected output format",
        ),
        sa.Column(
            "model_target",
            sa.String(length=50),
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=False,
            comment="draft, testing, active, deprecated",
        ),
    ...
    op.create_table(
        "curriculum_nodes",
        sa.Column(
            "code", sa.String(length=20), nullable=False, comment="Node code (e.g., 'B2.1.1.1')"
        ),
        sa.Column(
            "grade", sa.String(length=5), nullable=False, comment="Grade level ('B1' through 'B9')"
        ),
        sa.Column("strand_id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "severity_rationale", sa.Text(), nullable=True, comment="Why this severity rating"
        ),
        sa.Column(
            "questions_required",
            sa.SmallInteger(),
        ...
        sa.Column(
            "ghana_evidence", sa.Text(), nullable=True, comment="EGMA/NEA data, research citations"
        ),
        sa.Column(
            "population_status",
            sa.String(length=20),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=100),
            nullable=True,
            comment="How they want to be addressed",
        ),
        sa.Column(
            "preferred_language",
            sa.String(length=30),
            nullable=False,
            comment="ISO code or 'tw', 'ee', 'ga', 'dag'",
        ),
        sa.Column(
            "literacy_level",
            sa.String(length=20),
        ...
        sa.Column(
            "engagement_score", sa.Float(), nullable=True, comment="Rolling engagement metric"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Simulated input data",
        ),
        sa.Column(
            "expected_output",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="What the prompt should produce",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=False,
            comment="Type: primary, jhs, combined, private",
        ),
        sa.Column(
            "ges_school_code",
            sa.String(length=30),
            nullable=True,
            comment="Ghana Education Service school code",
        ),
        ...
        sa.Column(
            ...
            sa.String(length=30),
            nullable=False,
            comment="Primary language of instruction",
        ),
        sa.Column(
            "dominant_l1", sa.String(length=30), nullable=True, comment="Most common mother tongue"
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.Column("id", sa.Uuid(), nullable=False, comment="UUID primary key"),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "evidence", sa.Text(), nullable=False, comment="How it manifests (observable behavior)"
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "source_node_id", sa.UUID(), nullable=False, comment="Source node (depends on target)"
        ),
        sa.Column(
            "target_node_id", sa.UUID(), nullable=False, comment="Target node (prerequisite)"
        ),
        sa.Column(
            "relationship_type",
            sa.String(length=20),
    ...
    op.create_index(
        "idx_prerequisites_source", "curriculum_prerequisites", ["source_node_id"], unique=False
    )
    op.create_index(
        "idx_prerequisites_target", "curriculum_prerequisites", ["target_node_id"], unique=False
    )
    op.create_table(
        "parent_activities",
        ...
        sa.Column(
            "activity_description", sa.Text(), nullable=False, comment="The 3-minute activity"
        ),
        sa.Column(
            "materials_needed",
            sa.Text(),
            nullable=True,
            comment="What parent needs (bottle caps, paper, etc.)",
        ),
        ...
        sa.Column(
            "started_at", sa.DateTime(), nullable=True, comment="Parent confirmed they started"
        ),
        sa.Column(
            "completed_at", sa.DateTime(), nullable=True, comment="Parent confirmed completion"
        ),
        sa.Column(
            "parent_feedback", sa.Text(), nullable=True, comment="Optional feedback from parent"
        ),
        sa.Column("follow_up_session_id", sa.UUID(), nullable=True),
        sa.Column(
            "skill_improved", sa.Boolean(), nullable=True, comment="Did follow-up show improvement?"
        ),
        sa.Column("id", sa.Uuid(), nullable=False, comment="UUID primary key"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=False,
            comment="text, image, voice, button, list, template",
        ),
        sa.Column(
            "interaction_purpose",
            sa.String(length=30),
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=True,
            comment="Actual message text (encrypted at rest)",
        ),
        ...
        sa.Column(
            ...
            sa.String(length=100),
            nullable=True,
            comment="WhatsApp template name if applicable",
        ),
        sa.Column(
            "language_used",
            sa.String(length=30),
            nullable=True,
            comment="Language this message was in",
        ),
    ...
    op.create_index(
        "idx_interactions_purpose", "parent_interactions", ["interaction_purpose"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("phone_verified", sa.Boolean(), nullable=False),
        sa.Column(
            "grade_taught", sa.String(length=5), nullable=True, comment="Current grade (B1-B9)"
        ),
        sa.Column(
            "subjects",
            postgresql.ARRAY(sa.String(length=100)),
            nullable=True,
            comment="Array of subjects taught",
        ),
        sa.Column("onboarded_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("session_id", sa.UUID(), nullable=False),
        sa.Column(
            "question_order", sa.SmallInteger(), nullable=False, comment="Order within session"
        ),
        sa.Column("node_id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "question_media_url", sa.Text(), nullable=True, comment="Image/audio if applicable"
        ),
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=True,
            comment="Photo of exercise book, voice note",
        ),
        sa.Column("is_correct", sa.Boolean(), nullable=True),
        sa.Column(
            "response_time_seconds", sa.Integer(), nullable=True, comment="How long student took"
        ),
        sa.Column(
            "error_pattern_detected",
            sa.String(length=100),
            nullable=True,
            comment="Which error pattern matched",
        ),
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
            comment="Detailed AI reasoning about the response",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "indicates_gap_at", sa.UUID(), nullable=True, comment="Which node this error points to"
        ),
        sa.Column("created_at", sa.String(), server_default=sa.text("NOW()"), nullable=False),
        sa.CheckConstraint(
    ...
    op.create_foreign_key(
        None, "curriculum_sub_strands", "curriculum_strands", ["strand_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        None, "curriculum_nodes", "curriculum_sub_strands", ["sub_strand_id"], ["id"]
    )

    # Tables that depend on curriculum_nodes
    op.create_foreign_key(
        None, "cascade_paths", "curriculum_nodes", ["diagnostic_entry_point"], ["id"]
    )
    op.create_foreign_key(
        None, "curriculum_indicators", "curriculum_nodes", ["node_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None,
        "curriculum_misconceptions",
    ...
    op.create_foreign_key(
        None, "diagnostic_sessions", "curriculum_nodes", ["entry_node_id"], ["id"]
    )
    op.create_foreign_key(
        None, "diagnostic_sessions", "curriculum_nodes", ["root_gap_node_id"], ["id"]
    )
    op.create_foreign_key(
        None, "diagnostic_sessions", "prompt_versions", ["prompt_version_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        None, "gap_profiles", "curriculum_nodes", ["recommended_focus_node"], ["id"]
    )
    ...
    op.create_foreign_key(
        None, "parent_activities", "diagnostic_sessions", ["follow_up_session_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        None, "parent_interactions", "prompt_versions", ["prompt_version_id"], ["id"]
    )
    op.create_foreign_key(None, "parent_interactions", "students", ["student_id"], ["id"])

    # Diagnostic questions
    op.create_foreign_key(
        None, "diagnostic_questions", "curriculum_indicators", ["indicator_id"], ["id"]
    )
    op.create_foreign_key(
        None, "diagnostic_questions", "curriculum_misconceptions", ["misconception_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        None, "indicator_error_patterns", "curriculum_nodes", ["indicates_gap_at"], ["id"]
    )
    op.create_foreign_key(
        None,
        "indicator_error_patterns",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_gap_profiles_current", table_name="gap_profiles", postgresql_where="is_current = TRUE"
    )
